	...
	tests := []struct {
		...
		},
		{
			...
			expected: &clickhousestsexporter.Config{
				...
				ComponentsTimeRangeTableName:   "otel_components_time_range",
				RelationsTimeRangeTableName:    "otel_relations_time_range",
				ComponentsFieldValuesTableName: "otel_components_field_values",
				RelationsFieldValuesTableName:  "otel_relations_field_values",
				ComponentsTimeRangeMVName:      "otel_components_time_range_mv",
				RelationsTimeRangeMVName:       "otel_relations_time_range_mv",
