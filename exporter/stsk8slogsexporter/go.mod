module github.com/stackvista/sts-opentelemetry-collector/exporter/stsk8slogsexporter

go 1.26.6

require (
	github.com/StackVista/stackstate-receiver-go-client v0.0.0-20260923134955-da4accf0a231
