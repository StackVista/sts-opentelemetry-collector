// Package settingsproto provides primitives to interact with the openapi HTTP API.
//
...
import (
	...
	externalRef0 "github.com/stackvista/sts-opentelemetry-collector/extension/settingsproviderextension/generated/settingsschema"
)
...
// Defines values for ComponentPresentationType.
const (
	ComponentPresentationTypeComponentPresentation ComponentPresentationType = "ComponentPresentation"
)

// Defines values for ComponentTypeType.
const (
	ComponentTypeTypeComponentType ComponentTypeType = "ComponentType"
)
...
const (
	LayerTypeLayer LayerType = "Layer"
)

// Defines values for MainMenuGroupType.
const (
	MainMenuGroupTypeMainMenuGroup MainMenuGroupType = "MainMenuGroup"
)
...
// Defines values for RelationTypeType.
const (
	RelationTypeTypeRelationType RelationTypeType = "RelationType"
)

// Defines values for SettingType.
const (
	SettingTypeComponentPresentation       SettingType = "ComponentPresentation"
	SettingTypeDomain                      SettingType = "Domain"
	...
	SettingTypeLayer                       SettingType = "Layer"
	SettingTypeMainMenuGroup               SettingType = "MainMenuGroup"
	...
	SettingTypeRelationType                SettingType = "RelationType"
	...
	SettingTypeViewType                    SettingType = "ViewType"
...
// Defines values for ViewTypeType.
const (
	ViewTypeTypeViewType ViewTypeType = "ViewType"
)
...
// ComponentPresentation defines model for ComponentPresentation.
...
// ComponentPresentationType A definition for representing a component
type ComponentPresentationType string

// ComponentType defines model for ComponentType.
type ComponentType struct {
	// CreatedTimeStamp The timestamp of when the setting was created.
	CreatedTimeStamp int64                                 `json:"createdTimeStamp"`
	Description      *string                               `json:"description,omitempty"`
	Highlights       *externalRef0.ComponentTypeHighlights `json:"highlights,omitempty"`
	...
	Type ComponentTypeType `json:"type"`
}

// ComponentTypeType The type of a component
type ComponentTypeType string
...
// LayerType defines model for Layer.Type.
type LayerType string

// MainMenuGroup defines model for MainMenuGroup.
type MainMenuGroup struct {
	...
	Id         SettingId          `json:"id"`
	Identifier *string            `json:"identifier,omitempty"`
	Items      []MainMenuViewItem `json:"items"`
	Name       string             `json:"name"`
	Order      *float64           `json:"order,omitempty"`
	Shard      Shard              `json:"shard"`
	Type       MainMenuGroupType  `json:"type"`
}

// MainMenuGroupType defines model for MainMenuGroup.Type.
type MainMenuGroupType string

// MainMenuViewItem defines model for MainMenuViewItem.
type MainMenuViewItem struct {
	ViewIdentifier string `json:"viewIdentifier"`
}
...
// OtelAnyExpression An expression that can produce any type.
...
type OtelComponentMappingFieldMapping struct {
	...
	// Configuration An expression that can produce any type.
	// Variables use it to store any type of value. For example, to store a boolean in a variable named  `inTestNamespace` assign
	// it the expression `resource.attributes['service.namespace'] == 'test'`. The variable can now be used directly in the conditions like this: `vars.inTestNamespace`.
	Configuration *OtelAnyExpression `json:"configuration,omitempty"`

	// Status An expression that can produce any type.
	// Variables use it to store any type of value. For example, to store a boolean in a variable named  `inTestNamespace` assign
	// it the expression `resource.attributes['service.namespace'] == 'test'`. The variable can now be used directly in the conditions like this: `vars.inTestNamespace`.
...
type OtelTagMapping struct {
	...
	// Source An expression that can produce any type.
	// Variables use it to store any type of value. For example, to store a boolean in a variable named  `inTestNamespace` assign
	// it the expression `resource.attributes['service.namespace'] == 'test'`. The variable can now be used directly in the conditions like this: `vars.inTestNamespace`.
...
type OtelVariableMapping struct {
	...
	// Value An expression that can produce any type.
	// Variables use it to store any type of value. For example, to store a boolean in a variable named  `inTestNamespace` assign
	// it the expression `resource.attributes['service.namespace'] == 'test'`. The variable can now be used directly in the conditions like this: `vars.inTestNamespace`.
...
type RelationType struct {
	// CreatedTimeStamp The timestamp of when the setting was created.
	CreatedTimeStamp int64                       `json:"createdTimeStamp"`
	DependencyType   externalRef0.DependencyType `json:"dependencyType"`
	Description      *string                     `json:"description,omitempty"`
	...
	Type RelationTypeType `json:"type"`
}

// RelationTypeType The type of a relation
...
type ViewType struct {
	...
	CreatedTimeStamp int64                            `json:"createdTimeStamp"`
	Description      *string                          `json:"description,omitempty"`
	Filters          []externalRef0.ViewTypeFilter    `json:"filters"`
	Flags            []externalRef0.ViewTypeFlagValue `json:"flags"`
	Iconbase64       *string                          `json:"iconbase64,omitempty"`
	...
	Identifier *string                       `json:"identifier,omitempty"`
	Name       string                        `json:"name"`
	Overview   externalRef0.ViewTypeOverview `json:"overview"`
	Shard      Shard                         `json:"shard"`
	Type       ViewTypeType                  `json:"type"`
}

// ViewTypeType defines model for ViewType.Type.
type ViewTypeType string
...
// AsComponentPresentation returns the union data inside the Setting as a ComponentPresentation
func (t Setting) AsComponentPresentation() (ComponentPresentation, error) {
	var body ComponentPresentation
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromComponentPresentation overwrites any union data inside the Setting as the provided ComponentPresentation
func (t *Setting) FromComponentPresentation(v ComponentPresentation) error {
	t.Type = "ComponentPresentation"
...
// MergeComponentPresentation performs a merge with any union data inside the Setting, using the provided ComponentPresentation
func (t *Setting) MergeComponentPresentation(v ComponentPresentation) error {
	t.Type = "ComponentPresentation"
...
// AsComponentType returns the union data inside the Setting as a ComponentType
func (t Setting) AsComponentType() (ComponentType, error) {
	var body ComponentType
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromComponentType overwrites any union data inside the Setting as the provided ComponentType
func (t *Setting) FromComponentType(v ComponentType) error {
...
// MergeComponentType performs a merge with any union data inside the Setting, using the provided ComponentType
func (t *Setting) MergeComponentType(v ComponentType) error {
	t.Type = "ComponentType"
...
// AsRelationType returns the union data inside the Setting as a RelationType
func (t Setting) AsRelationType() (RelationType, error) {
	var body RelationType
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromRelationType overwrites any union data inside the Setting as the provided RelationType
func (t *Setting) FromRelationType(v RelationType) error {
	t.Type = "RelationType"
...
// MergeRelationType performs a merge with any union data inside the Setting, using the provided RelationType
func (t *Setting) MergeRelationType(v RelationType) error {
	t.Type = "RelationType"
...
// AsLayer returns the union data inside the Setting as a Layer
func (t Setting) AsLayer() (Layer, error) {
	var body Layer
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromLayer overwrites any union data inside the Setting as the provided Layer
func (t *Setting) FromLayer(v Layer) error {
	t.Type = "Layer"
...
// MergeLayer performs a merge with any union data inside the Setting, using the provided Layer
func (t *Setting) MergeLayer(v Layer) error {
	t.Type = "Layer"
...
// AsDomain returns the union data inside the Setting as a Domain
func (t Setting) AsDomain() (Domain, error) {
	var body Domain
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromDomain overwrites any union data inside the Setting as the provided Domain
func (t *Setting) FromDomain(v Domain) error {
	t.Type = "Domain"
...
// MergeDomain performs a merge with any union data inside the Setting, using the provided Domain
func (t *Setting) MergeDomain(v Domain) error {
	t.Type = "Domain"
...
// AsMainMenuGroup returns the union data inside the Setting as a MainMenuGroup
func (t Setting) AsMainMenuGroup() (MainMenuGroup, error) {
	var body MainMenuGroup
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromMainMenuGroup overwrites any union data inside the Setting as the provided MainMenuGroup
func (t *Setting) FromMainMenuGroup(v MainMenuGroup) error {
	t.Type = "MainMenuGroup"
...
// MergeMainMenuGroup performs a merge with any union data inside the Setting, using the provided MainMenuGroup
func (t *Setting) MergeMainMenuGroup(v MainMenuGroup) error {
	t.Type = "MainMenuGroup"
...
// AsViewType returns the union data inside the Setting as a ViewType
func (t Setting) AsViewType() (ViewType, error) {
	var body ViewType
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromViewType overwrites any union data inside the Setting as the provided ViewType
func (t *Setting) FromViewType(v ViewType) error {
	t.Type = "ViewType"
...
// MergeViewType performs a merge with any union data inside the Setting, using the provided ViewType
func (t *Setting) MergeViewType(v ViewType) error {
	t.Type = "ViewType"
...
func (t Setting) ValueByDiscriminator() (interface{}, error) {
	...
	switch discriminator {
	case "ComponentPresentation":
		return t.AsComponentPresentation()
	case "ComponentType":
		return t.AsComponentType()
	case "Domain":
		return t.AsDomain()
	case "ExternalMonitor":
		return t.AsExternalMonitor()
